...
INSERT INTO `fruit`.`karyawan` (`idkaryawan`, `idstatus`, `idposisi`, `namapanjang`, `email`, `password`, `alamat`, `kontak`, `gender`) VALUES (1, 11110, 4, 'Jaka Ardiola', 'Jack@gg.com', '1232', NULL, NULL, 'M');
