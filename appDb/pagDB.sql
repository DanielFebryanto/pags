...
-- -----------------------------------------------------
-- Data for table `u830941605_dbs`.`menus`
-- -----------------------------------------------------
START TRANSACTION;
USE `u830941605_dbs`;
INSERT INTO `u830941605_dbs`.`menus` (`id`, `menuname`, `icon`, `description`, `createby`, `createon`, `modifby`, `modifon`, `version`, `iorder`, `statuses_id`) VALUES ('UAM', 'UAM', NULL, 'User Acces Management', NULL, NULL, NULL, NULL, NULL, NULL, DEFAULT);
